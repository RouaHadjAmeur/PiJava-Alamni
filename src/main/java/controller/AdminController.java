...
public class AdminController {
    ...
    private void handleReclamations(ActionEvent event) {
        try {
            ...
            // Récupérer la fenêtre (Stage) actuelle proprement
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Impossible de charger le Dashboard Réclamations.");
        }
    }
    ...
    private void handleCours(ActionEvent event) {
        try {
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Impossible de charger le Dashboard Cours.");
        }
    }
    ...
    private void handleConfiguration() {
        showAlert(Alert.AlertType.INFORMATION, "Configuration du système");
    }
