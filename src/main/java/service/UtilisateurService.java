...
public class UtilisateurService {
    ...
    // Map temporaire pour stocker les codes de réinitialisation
    ...
    // Stocker un code de réinitialisation temporaire
    public static void storeResetCode(String email, String code) {
        System.out.println("Stockage du code de réinitialisation pour " + email + ": " + code);
    ...
    public static boolean verifyResetCode(String email, String code) {
        ...
        System.out.println("Vérification du code pour " + email);
        System.out.println("Code stocké: " + storedCode + ", Code fourni: " + code);
    ...
    public static void storeResetToken(String email, String token) {
        resetTokens.put(token, new ResetToken(token, email));
    }

    // Vérifier si un token est valide et récupérer l'email associé
