...
public class EmailService {
    ...
    public static boolean envoyerMail(String to, String subject, String body) {
        final String from = FROM_EMAIL;
        final String password = PASSWORD;

        Properties props = new Properties();
        props.put("mail.smtp.auth", "true");
        props.put("mail.smtp.starttls.enable", "true");
        props.put("mail.smtp.ssl.protocols", "TLSv1.2"); // ✅ IMPORTANT
        props.put("mail.smtp.ssl.trust", "*"); // ✅ NE PAS VÉRIFIER LE CERTIFICAT (test uniquement !)
        props.put("mail.smtp.host", "smtp.gmail.com");
        props.put("mail.smtp.port", "587");
        ...
        try {
            ...
            e.printStackTrace();
            System.err.println("❌ Échec de l’envoi de mail à " + to);
            return false;
        }
    }
}